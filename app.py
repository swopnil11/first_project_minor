...
def upload():
	...
	if request.form['Submit'] == 'Submit':
		...
		train = pd.read_csv(r"C:\Time-Series-Analysis-on-passenger-count-main\index\train_sample.csv")
		...
		if file and allowed_file(file.filename):
			...
			file.save(r'C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Result.csv')

			train= pd.read_csv(r"C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Result.csv" )
	...
	test = pd.read_csv("C:\Time-Series-Analysis-on-passenger-count-main\index\Test_0qrQsBZ.csv" )
	...
	plt.legend(loc='best')
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Timeseries.png')
	plt.clf()
	...
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\subplot.png')
	...
	plt.ylabel("Passenger count")
	plt.legend(loc='best')
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Validating_3_month.png')
	plt.clf()
  ...
  # Construction-of--an-SARIMA-model#dicky fuller test for finding stationary
	...
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Roll_m_stand_d.png')
	plt.clf()
	...
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Roll_m_stand_d_no_trend.png')
	plt.clf()
	...
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Test_stationary.png')
	plt.clf()
	...
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Make_stationary.png')
	plt.clf()
	# removing seasonality

	from statsmodels.tsa.seasonal import seasonal_decompose
	Train_log.interpolate(inplace = True)
	...
	plt.legend(loc='best')
	plt.tight_layout()
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Roll_m_stand_d_no_seas.png')
	plt.clf()
	...
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\parameter1_of_sarima.png')
	plt.clf()
	...
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\parameter2_of_sarima.png')
	plt.clf()
	...
	plt.legend(loc='best')
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\Fitting_model.png')
	plt.clf()
	...
	submission = pd.read_csv(r"C:\Time-Series-Analysis-on-passenger-count-main\index\submission.csv")
	...
	pd.DataFrame(temp, columns=['Hour', 'ratio']).to_csv('C:\Time-Series-Analysis-on-passenger-count-main\index\GROUPby.csv')

	temp2 = pd.read_csv("C:\Time-Series-Analysis-on-passenger-count-main\index\GROUPby.csv")
	...
	pd.DataFrame(submission, columns=['ID', 'Datetime', 'Count']).to_csv("C:\Time-Series-Analysis-on-passenger-count-main\index\SARIMAX.csv")
	# observing the graph
	Sarima = pd.read_csv(r"C:\Time-Series-Analysis-on-passenger-count-main\index\SARIMAX.csv")
	...
	plt.legend(loc='best')
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\prediction.png')
	plt.clf()

	Sarima = pd.read_csv("C:\Time-Series-Analysis-on-passenger-count-main\index\SARIMAX.csv")
	Sarima['Datetime'] = pd.to_datetime(Sarima.Datetime, format='%Y-%m-%d %H:%M:%S')
	...
	plt.ylabel("Passenger count")
	plt.legend(loc='best')
	plt.savefig('C:\Time-Series-Analysis-on-passenger-count-main\static\plots\prediction_graph.png')
	plt.clf()
	global Sum
	Sarima = pd.read_csv(r"C:\Time-Series-Analysis-on-passenger-count-main\index\SARIMAX.csv")
	Sum=Sarima['Count'].sum()
	return render_template("main_result.html",rms=round(rms,2),dfoutput=dfoutput,Sum=math.trunc(Sum))

#Sarima = pd.read_csv("C:\Time-Series-Analysis-on-passenger-count-main\index\SARIMAX.csv")
#Sarima['Count'] = math.trunc(Sarima['Count'])
#Sarima.to_csv("C:\Time-Series-Analysis-on-passenger-count-main\index\SARIMAX.csv", index = False)
...
def template():
	...
	if request.method == "POST":
		...
		elif request.form['Submit'] == 'last 3 months taken for validation part':
		...
		elif request.form['Submit'] == 'Rolling mean and standard deviation showing trend':
		...
		elif request.form['Submit'] == 'Decomposition of Time Series Data':
